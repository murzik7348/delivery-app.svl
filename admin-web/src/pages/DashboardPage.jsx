              ...
              return (
                <div key={staff.phone} className="bg-surface/50 border border-borderWhite rounded-xl p-4 hover:border-primary/50 transition-colors">
                  <div className="flex items-center mb-3">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center mr-3 text-white font-bold ${staff.role === 'Admin' ? 'bg-primary' :
                  ...
                  <div className="flex justify-between items-center text-xs">
                    ...
                    <span className={`px-2 py-0.5 rounded border border-borderWhite ${staff.role === 'Admin' ? 'text-primary bg-primary/10' :
