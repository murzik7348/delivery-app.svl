...
const initialState = {
  selectedMethodId: '2',  // Default: Online (Card/Apple Pay) = paymentMethodId:2 on backend
  methods: [
    { id: '2', type: 'Apple Pay', icon: 'logo-apple', color: 'black', number: 'Visa / MasterCard' },
    { id: '1', type: 'Готівка', icon: 'cash', color: '#2ecc71', number: 'При отриманні' },
  ],
};
